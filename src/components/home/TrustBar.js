...
const items = [
  ...
  },
  {
    ...
    link: { label: "Honorary Doctorate Guide", href: "/programs/honorary-doctorate" },
  },
  {
    num: "03",
    tag: "Verification",
    title: "Anyone can verify a credential issued through us",
    sub: "personally confirmed.",
    desc: "Employers, background-check teams, family members — anyone can request confirmation of a Techversity-issued certificate or degree. A named advisor checks it against the issuing institution's own register — no automated guesswork.",
    stat: "24hr",
