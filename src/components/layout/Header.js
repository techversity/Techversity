...
export default function Header() {
  ...
  const programItems = [
    {
      ...
      desc: "PhD, DBA & Honorary — for senior professionals.",
      href: "/doctorate",
    },
    {
      label: "Master's & MBA",
      desc: "Globally recognised master's, 100% online.",
      href: "/programs/masters",
    },
    {
      label: "Bachelor's Programs",
      desc: "Foundational degrees to begin your path.",
      href: "/programs/bachelors",
    },
    {
      label: "Executive Education",
      desc: "Short, high-impact programs for leaders.",
      href: "/programs/executive-education",
    },
    {
      label: "Certifications",
      desc: "Career-ready skills in weeks, with support.",
      href: "/certifications",
    },
  ];
  ...
  return (
    <>
        ...
        <div className="max-w-[1260px] mx-auto px-5 lg:px-8 flex items-center justify-between h-16 lg:h-[70px]">
          ...
          <Link href="/" className="flex items-center gap-2.5" onClick={close}>
            <img
              ...
              className="w-12 h-12 lg:w-[48px] lg:h-[48px] object-contain"
            />
          ...
          <nav className="hidden lg:flex items-center gap-0.5">
            ...
            <div className="group relative">
              ...
              >
                Programs
                <span className="text-[11px] text-gold group-hover:rotate-180 transition-transform duration-200">
                  ▾
                </span>
              </Link>
                ...
                <div className="bg-white border border-line rounded-xl shadow-[0_16px_50px_rgba(22,38,61,0.16)] p-5 w-[620px] grid grid-cols-2 gap-x-6 gap-y-1">
                  <div className="col-span-2 bg-ink rounded-lg p-5 mb-2">
                    ...
                    <p className="text-sm text-white/80 leading-relaxed">
                      Doctoral advancement, executive education, and
                      career-ready certifications — guided end-to-end.
                    </p>
                  </div>
      ...
      {/* mobile drawer */}
      <div
        className={`lg:hidden fixed inset-0 z-[60] ${open ? "visible" : "invisible"}`}
      >
        <div
        ...
        >
          <div className="flex items-center justify-between mb-5">
            ...
            <button
              onClick={close}
              className="text-2xl text-wine leading-none px-1"
          ...
          <div className="border-b border-line">
            ...
            >
              Programs
              <span
                className={`text-gold transition-transform ${progOpen ? "rotate-180" : ""}`}
              >
                ▾
              </span>
            </button>
              ...
              <div className="pb-3 pl-3 flex flex-col gap-2">
                {programItems.map((item) => (
                  <Link
                    ...
                    href={item.href}
                    onClick={close}
                    className="text-sm text-slate py-1"
                  >
                    {item.label}
                  </Link>
                ))}
