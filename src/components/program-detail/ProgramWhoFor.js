...
const ICON_MAP = {
  ...
  // DBA
  "CEOs & Board Members": Crown,
  "Business Owners": Store,
  "Senior Managers": UserCog,
  "Management Consultants": ClipboardList,
  "Government & Policy Leaders": Vote,
  "Academics & Educators": GraduationCap,
  "Senior Directors": Compass,
  // PhD
  "University Faculty": School,
  "Corporate Professionals": Building2,
  "Policy Experts": ScrollText,
  "Healthcare Professionals": Stethoscope,
  "Government Officers": Building,
  "Independent Scholars": BookMarked,
  // Honorary Professorship
  "Higher Education Leaders": GraduationCap,
  "Researchers & Innovators": Microscope,
  "Engineers & Technologists": Cpu,
...
export default function ProgramWhoFor({ p }) {
  ...
  return (
    <section className="relative bg-ivory overflow-hidden">
      <div
        className="absolute -top-40 -right-40 w-[560px] h-[560px] rounded-full blur-[160px] opacity-[0.12] pointer-events-none"
      ...
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle at 1px 1px,#16263D 1px,transparent 0)",
          ...
          <Reveal direction="right">
            <div>
              ...
              <h2 className="font-display font-semibold text-[36px] lg:text-[54px] text-wine leading-[1.02] mb-7">
                Wherever <span className="italic text-gold">extraordinary</span>
                <br />
                work is done.
              </h2>
          ...
          {collage.length > 0 && (
            <Reveal direction="left" delay={120}>
              <div className="relative h-[300px] lg:h-[340px]">
                ...
                >
                  <path
                    d="M 40 260 Q 140 60 220 150 T 400 70"
                    stroke="#9A7320"
                    strokeWidth="1.5"
                    strokeDasharray="4 7"
                    opacity="0.35"
                ...
                <div className="absolute -bottom-3 left-[38%] bg-wine rounded-full pl-2 pr-4 py-2 flex items-center gap-2.5 shadow-[0_15px_35px_-8px_rgba(22,38,61,0.35)] z-20">
                  <span className="w-7 h-7 rounded-full bg-gold/20 flex items-center justify-center font-display font-bold text-[11px] text-gold">
                    10+
                  </span>
                  <span className="font-mono text-[9px] uppercase tracking-wide text-white/80 whitespace-nowrap">
                    Recognised Profiles
                  </span>
                </div>
              </div>
