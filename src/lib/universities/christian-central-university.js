...
const ccuDetail = {
  ...
  shortName: "CCU",
  motto: "Mind of a Scholar, Heart of a Shepherd, Perseverance of a Soldier",
  ...
  mode: "Online",
  language: "English",
  studentsServed: "Faith-driven professionals, global",
  ...
  facts: [
    ...
    { label: "Location", value: "Orlando, Florida, USA" },
    { label: "Delivery", value: "100% Online" },
    { label: "Language", value: "English" },
    { label: "Licensure", value: "Florida Commission for Independent Education" },
    { label: "Public Catalogue", value: "Bachelor's · Master's" },
    { label: "Doctoral/Honorary/Exec.", value: "Via advisory partnership" },
    { label: "Founder", value: "Dr. Juan Carlos Amesty" },
  ],

  // ── ACCREDITATION ──
  accreditation: [
    { name: "Florida Commission for Independent Education", note: "State licensure, License No. 7870 — a state license, not a national or regional accreditation. Recognition details are confirmed with your advisor before any application begins." },
  ],
  accreditationNote:
  ...
  ctaLine: "CCU's public catalogue opens one door. Techversity's advisory partnership opens another — and we tell you plainly which is which.",
};

export default ccuDetail;